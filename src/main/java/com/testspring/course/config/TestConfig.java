...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order or1 = new Order(null, Instant.parse("2024-01-06T19:53:07Z"), user1);
        Order or2 = new Order(null, Instant.parse("2024-01-02T03:42:10Z"), user2);
        Order or3 = new Order(null, Instant.parse("2024-01-06T15:21:22Z"), user1);
